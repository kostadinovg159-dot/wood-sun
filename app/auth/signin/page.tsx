    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md w-full text-center">
          ...
          <button onClick={() => setSent(false)} className="text-sm text-wood-600 hover:underline">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md w-full">
        <Link href="/" className="flex items-center gap-2 font-bold text-xl text-wood-700 mb-8">
          <span>🌿</span> WoodSun
        </Link>

        <h1 className="text-2xl font-bold text-gray-900 mb-2">Sign in</h1>
        <p className="text-gray-600 mb-8">Track your orders and manage your account.</p>
